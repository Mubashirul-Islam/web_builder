...
urlpatterns = [
    ...
    path(
        "websites/<int:pk>/edit/refresh/",
        views.WebsiteEditRefresh.as_view(),
        name="website-edit-refresh",
    ),
    path(
        "websites/<int:pk>/edit/save/",
        views.WebsiteEditSave.as_view(),
        name="website-edit-save",
    ),
    path(
        "websites/<int:pk>/edit/exit/",
